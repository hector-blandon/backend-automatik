...
router.get('/clientes/buscarClientes', clienteControlador.buscarClientes);
...
router.get('/mecanicos/buscarMecanicos', mecanicoControlador.buscarMecanicos);
...
router.get('/administrador/buscarAdministradores', administradorControlador.buscarAdministradores);
...
router.get('/pieza/buscarPiezas', piezaControlador.buscarPiezas);
...
router.get('/vehiculos/buscarVehiculos', vehiculoControlador.buscarVehiculos);
